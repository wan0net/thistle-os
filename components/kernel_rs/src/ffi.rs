...
#[no_mangle]
pub unsafe extern "C" fn rs_manifest_parse_file(
...
#[no_mangle]
pub unsafe extern "C" fn rs_manifest_is_compatible(
...
#[no_mangle]
pub unsafe extern "C" fn rs_manifest_path_from_elf(
...
#[no_mangle]
pub extern "C" fn rs_kernel_version() -> *const c_char {
