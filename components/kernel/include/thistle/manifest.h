...
/*
 * This type is populated by the Rust manifest parser across the C ABI.
 * Keep these assertions in the public header so every C and C++ consumer
 * verifies the same layout that components/kernel_rs/src/ffi.rs exports.
 */
