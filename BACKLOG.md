...
### Priority 9: LoRa Mesh Relay Protocol
**Status:** PENDING
**Personas:** Cairn (multi-hop SAR), Ember (field station mesh)
**Description:** Message routing protocol for LoRa mesh networks. Hop counting, TTL, relay selection, deduplication. Pure protocol logic, testable without hardware.
